...
{
    public class Developer2 : IColleague
    {
        private ISystemMediator _mediator;
        private string TriggerKeyword = "employees json";
        private string CollegueName = "Developer2";
        ...
        public Developer2(ISystemMediator mediator)
        {
            _mediator = mediator;
